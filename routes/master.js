...
router.post('/masterjenisbahan/tambah', async function(req, res, next) {
 ...
 // master varian bahan 
router.get('/mastervarianbahan',async function(req, res, next) {
   res.render('index', { title: 'Master varian Bahan', page:'master-data/master-varianbahan/mastervarianbahan.ejs'});
})
